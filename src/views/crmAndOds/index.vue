...
export default {
  ...
  data() {
    return {
      ...
      tableColumnList: [{ prop: 'odsCustomerId', label: '客户号' }, { prop: 'odsCustomerName', label: '客户姓名' }, { prop: 'odsUseCaseCustomerLabel', label: '客群标签' }, { prop: 'odsIsExecuteCustomer', label: '是否执行' }, { prop: 'odsPhoneNum', label: '电话号码' }, { prop: 'odsExecutorId', label: '执行人工号' }, { prop: 'odsExecutorName', label: '执行人姓名' }, { prop: 'odsExecutorOutlet', label: '执行人所属网点号' }, { prop: 'odsExecutorOutletName', label: '执行人所属网点名称' }, { prop: 'odsExecutorSubBranchId', label: '执行人所属支行号' }, { prop: 'odsExecutorSubBranchName', label: '执行人所属支行名称' }, { prop: 'odsBmpExecutorId', label: '平台分配执行人工号' }, { prop: 'odsBmpExecutorName', label: '平台分配执行人姓名' }, { prop: 'odsBmpExecutorOutlet', label: '平台分配执行人所属网点号' }, { prop: 'odsBmpExecutorOutletName', label: '平台分配执行人所属网点名称' }, { prop: 'odsBmpExecutorSubBranchId', label: '平台分配执行人所属支行号' }, { prop: 'odsBmpExecutorSubBranchName', label: '平台分配执行人所属支行名称' }, { prop: 'odsUseCaseName', label: '用例名称' }, { prop: 'odsEffectDate', label: '生效日期' }, { prop: 'odsInvalidDate', label: '失效日期' }, { prop: 'clueExecuteDate', label: '执行时间' }, { prop: 'crmProcessResult', label: '处理状态' }, { prop: 'odsCrmProcessResultDetail', label: '处理结果详情' }, { prop: 'remarks', label: '处理备注' }]
    }
  },
  computed: {
    parentRef() {
